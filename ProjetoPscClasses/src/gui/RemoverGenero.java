 ...
 */
public class RemoverGenero extends javax.swing.JFrame {
     IFachada fachada = Fachada.obterInstancia();
      long codigo;
      ListarGenero lstG;
    /**
     * Creates new form RemoverGenero
     */
    public RemoverGenero(Genero genero, ListarGenero lstG) {
        initComponents();
        this.lstG=lstG;
        codigo=genero.getId();
    ...
    private void initComponents() {
        ...
        textGeneroGenero.setEnabled(false);
    ...
    private void ButtonRemoverGeneroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonRemoverGeneroActionPerformed
        // TODO add your handling code here:
         try {
          // TODO add your handling code here:
          fachada.removerGenero(codigo);
          JOptionPane.showMessageDialog(rootPane, "Gênero Removido com sucesso");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemoverGenero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RemoverGenero().setVisible(true);
            }
        });
    }
