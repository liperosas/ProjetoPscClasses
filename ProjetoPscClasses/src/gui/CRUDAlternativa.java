 ...
 */
public class CRUDAlternativa extends javax.swing.JFrame {

    /**
     * Creates new form CRUDAlternativa
     */
    CRUDQuestao crudq;
    Fachada fachada = Fachada.obterInstancia();

    public CRUDAlternativa(CRUDQuestao crudq) {
        initComponents();
        this.crudq = crudq;
    }

    private CRUDAlternativa() {
    ...
    private void initComponents() {
        ...
        ButtonLimparAlternativa = new javax.swing.JButton();
        ButtonSalvarAlternativa = new javax.swing.JButton();
        ...
        ButtonLimparAlternativa.setText("Cancelar");
        ButtonLimparAlternativa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ButtonLimparAlternativaActionPerformed(evt);
            }
        });

        ButtonSalvarAlternativa.setText("Salvar");
        ButtonSalvarAlternativa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ButtonSalvarAlternativaActionPerformed(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addComponent(ButtonLimparAlternativa)
                        .addGap(30, 30, 30)
                        .addComponent(ButtonSalvarAlternativa)))
    ...
    private void ButtonSalvarAlternativaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonSalvarAlternativaActionPerformed
        // TODO add your handling code here:
        try {
            Alternativa alternativa = new Alternativa();
            alternativa.setTexto(jTextArea1.getText());
            crudq.questaoMultipla.getAlternativas().add(alternativa);
            crudq.carregarAlternativas();
            this.dispose();
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(crudq, ex.getMessage());
        }
    }//GEN-LAST:event_ButtonSalvarAlternativaActionPerformed

    private void ButtonLimparAlternativaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonLimparAlternativaActionPerformed
        // TODO add your handling code here:
        this.dispose();
    }//GEN-LAST:event_ButtonLimparAlternativaActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CRUDAlternativa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CRUDAlternativa().setVisible(true);
            }
        });
    }
    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton ButtonLimparAlternativa;
    private javax.swing.JButton ButtonSalvarAlternativa;
