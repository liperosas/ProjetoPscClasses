...
public class AlterarLocal extends javax.swing.JFrame {
   IFachada fachada = Fachada.obterInstancia();
    ...
    /**
     * Creates new form AlterarLocal
     */
    public AlterarLocal(Local local,ListarLocal le) {
        initComponents();
        this.le=le;
        codigo= local.getId();
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(32, 32, 32)
                        .addComponent(textCEPLocal, javax.swing.GroupLayout.DEFAULT_SIZE, 198, Short.MAX_VALUE)
                        .addGap(208, 208, 208))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
    ...
    private void buttonAlterarLocalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAlterarLocalActionPerformed
        ...
        try {
         ...
         JOptionPane.showMessageDialog(rootPane,"Local Alterado com sucesso");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlterarLocal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AlterarLocal().setVisible(true);
            }
        });
    }
