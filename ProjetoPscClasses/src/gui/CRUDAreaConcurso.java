...
public class CRUDAreaConcurso extends javax.swing.JFrame {
    ...
    public CRUDAreaConcurso(AreaConcurso areaConcurso, CRUDConcurso crudC, int posicao) {
        initComponents();
        alterar = true;
        this.crdC = crudC;
        ...
        this.fases = (ArrayList<Fase>) areaConcurso.getFases();
        this.carregarListaFases();
    }
    ...
    private void initComponents() {
        ...
        ButtonLimparAreaConcurso.setText("Cancelar");
        ButtonLimparAreaConcurso.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ButtonLimparAreaConcursoActionPerformed(evt);
            }
        });
...
//        altF.setVisible(true);
    ...
    private void ButtonLimparAreaConcursoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonLimparAreaConcursoActionPerformed
        // TODO add your handling code here:
        this.dispose();
    }//GEN-LAST:event_ButtonLimparAreaConcursoActionPerformed
