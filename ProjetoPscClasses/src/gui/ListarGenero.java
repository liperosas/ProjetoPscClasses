 ...
 */
public class ListarGenero extends javax.swing.JFrame {
     IFachada fachada = Fachada.obterInstancia();
    DefaultTableModel modelo = new DefaultTableModel();
    /**
     * Creates new form ListarGenero
     */
    public ListarGenero() {
        initComponents();
        this.carregarTabelaGenero();
    }
     public void carregarTabelaGenero() {
        try {
            ...
            for (Genero genero : generos) {
                modelo.addRow(new String[]{Long.toString(genero.getId()),genero.getGenero()});
            }
            TableGenero.setModel(modelo);
    ...
    private void initComponents() {
        ...
        ButtonCadastrarGenero = new javax.swing.JButton();
        ButtonRemoverGenero = new javax.swing.JButton();
        ButtonAlterarGenero = new javax.swing.JButton();
        ButtonListarGenero = new javax.swing.JButton();
        ...
        TableGenero.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        jScrollPane1.setViewportView(TableGenero);

        ButtonCadastrarGenero.setText("Cadastrar");
        ButtonCadastrarGenero.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ButtonCadastrarGeneroActionPerformed(evt);
            }
        });

        ButtonRemoverGenero.setText("Remover");
        ButtonRemoverGenero.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ButtonRemoverGeneroActionPerformed(evt);
            }
        });
        ...
        ButtonListarGenero.setText("Listar");
        ButtonListarGenero.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ButtonListarGeneroActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(3, 3, 3)
                        .addComponent(ButtonListarGenero)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(ButtonCadastrarGenero)
                        .addGap(18, 18, 18)
                        .addComponent(ButtonRemoverGenero)
                        .addGap(18, 18, 18)
    ...
    private void ButtonListarGeneroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonListarGeneroActionPerformed
        // TODO add your handling code here:
        this.carregarTabelaGenero();
    }//GEN-LAST:event_ButtonListarGeneroActionPerformed
    ...
    private void ButtonRemoverGeneroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonRemoverGeneroActionPerformed
       ...
       JOptionPane.showMessageDialog(rootPane, "Selecione um Gênero para Excluir");
        ...
        try {
            int codigo = TableGenero.getSelectedRow();
            genero = fachada.consultarGeneroPorId(Long.parseLong(TableGenero.getValueAt(codigo, 0).toString()));
            RemoverGenero rmvG= new RemoverGenero(genero, this);
            rmvG.setVisible(true);
            this.carregarTabelaGenero();
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(rootPane, ex.getMessage());
        }
    }          
    }//GEN-LAST:event_ButtonRemoverGeneroActionPerformed
    ...
    private void ButtonAlterarGeneroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonAlterarGeneroActionPerformed
       ...
       JOptionPane.showMessageDialog(rootPane, "Selecione um Gênero para Alterar");
        ...
        try {
            int codigo = TableGenero.getSelectedRow();
            genero = fachada.consultarGeneroPorId(Long.parseLong(TableGenero.getValueAt(codigo, 0).toString()));
            AlterarGenero altG= new AlterarGenero(genero, this);
            altG.setVisible(true);
            this.carregarTabelaGenero();
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(rootPane, ex.getMessage());
        }
    ...
    private void ButtonCadastrarGeneroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonCadastrarGeneroActionPerformed
        // TODO add your handling code here:
        CRUDGenero crudG=new CRUDGenero(this);
        crudG.setVisible(true);
    }//GEN-LAST:event_ButtonCadastrarGeneroActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListarGenero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListarGenero().setVisible(true);
            }
        });
    }
    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton ButtonAlterarGenero;
    private javax.swing.JButton ButtonCadastrarGenero;
    private javax.swing.JButton ButtonListarGenero;
    private javax.swing.JButton ButtonRemoverGenero;
