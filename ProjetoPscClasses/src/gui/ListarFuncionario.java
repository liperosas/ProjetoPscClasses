...
public class ListarFuncionario extends javax.swing.JFrame {
    ...
    public void carregarTabelaFucinonarios() {
        ...
        try {
            ...
            modelo.setColumnIdentifiers(new Object[]{"Id", "Nome", "CPF", "RG", "CTPS", "Data Nasc.", "Telefone", "Celular", "Salario", "CEP", "Numero"});
            for (Funcionario funcionario : funcionarios) {
                modelo.addRow(new String[]{Long.toString(funcionario.getId()), funcionario.getNome(), funcionario.getCpf(), funcionario.getRg(), funcionario.getCtps(), (funcionario.getData_nasc().get(5) + "/" + funcionario.getData_nasc().get(2) + "/" + funcionario.getData_nasc().get(1)), funcionario.getTelefone(), funcionario.getCelular(), Double.toString(funcionario.getSalario()), funcionario.getEndereco().getCep(), funcionario.getEndereco().getNumero()});
            }
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(buttonListarFuncionario, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(36, 36, 36)
    ...
    private void buttonListarFuncionarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonListarFuncionarioActionPerformed
    ...
    private void buttonRemoverFuncionarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonRemoverFuncionarioActionPerformed
       ...
       JOptionPane.showMessageDialog(rootPane, "Selecione um funcionário para remover");
        ...
        try {
            ...
            funcionario = fachada.consultarFuncionarioPorId(Long.parseLong(tableFuncionario.getValueAt(codigo, 0).toString()));
