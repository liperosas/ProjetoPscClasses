 ...
 */
public class ListarConcurso extends javax.swing.JFrame {
    IFachada fachada = Fachada.obterInstancia();
    DefaultTableModel modelo = new DefaultTableModel();
    /**
     * Creates new form ListarConcurso
     */
    public ListarConcurso() {
     ...
     */
    public void carregarTabelaConcurso() {
        try {
            modelo = new DefaultTableModel();
            modelo.setColumnIdentifiers(new Object[]{"Id", "NomeConcurso","NomeEmpresa","Data","DataFinal" });
            ArrayList<Concurso> concursos = new ArrayList<Concurso>();
            concursos = (ArrayList<Concurso>) fachada.consultarTodosConcurso();
            for (Concurso concurso : concursos) {
                modelo.addRow(new String[]{Long.toString(concurso.getId()),concurso.getNomeConcurso(),concurso.getEmpresa().getNome(),(concurso.getDatainscricao().get(5) + "/" + concurso.getDatainscricao().get(2) + "/" + concurso.getDatainscricao().get(1)),(concurso.getDatafinal().get(5) + "/" + concurso.getDatafinal().get(2) + "/" + concurso.getDatafinal().get(1))});
            }
            TabelaListarConcurso.setModel(modelo);
    ...
    private void initComponents() {
        ...
        ButtonCadastrarConcurso = new javax.swing.JButton();
        jScrollPane1 = new javax.swing.JScrollPane();
        TabelaListarConcurso = new javax.swing.JTable();
        ButtonListarConcurso = new javax.swing.JButton();
        ...
        ButtonCadastrarConcurso.setText("Cadastrar");
        ButtonCadastrarConcurso.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ButtonCadastrarConcursoActionPerformed(evt);
            }
        });

        TabelaListarConcurso.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        TabelaListarConcurso.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        jScrollPane1.setViewportView(TabelaListarConcurso);

        ButtonListarConcurso.setText("Listar");
        ButtonListarConcurso.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ButtonListarConcursoActionPerformed(evt);
            }
        });

        jLabel1.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jLabel1.setText("Lista de Concursos");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addComponent(ButtonListarConcurso, javax.swing.GroupLayout.PREFERRED_SIZE, 66, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(ButtonCadastrarConcurso)
                        .addGap(24, 24, 24)
                        .addComponent(buttonRemoverConcurso, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(buttonAlterarConcurso, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(ButtonCadastrarConcurso)
                    .addComponent(ButtonListarConcurso))
                .addContainerGap())
        );
    ...
    private void buttonRemoverConcursoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonRemoverConcursoActionPerformed
       ...
       if(TabelaListarConcurso.getSelectedRow()==-1){
       JOptionPane.showMessageDialog(rootPane, "Selecione um concurso para remover");
       }else{
        ...
        try {
            ...
            RemoverConcurso rmvC = new RemoverConcurso(concurso, this);
            rmvC.setVisible(true);
    ...
    private void buttonAlterarConcursoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAlterarConcursoActionPerformed
        // TODO add your handling code here:
        if(TabelaListarConcurso.getSelectedRow()==-1){
       JOptionPane.showMessageDialog(rootPane, "Selecione um concurso para alterar");
       }else{
        Concurso concurso=new Concurso();
        try {
            int codigo = TabelaListarConcurso.getSelectedRow();
    ...
    private void ButtonCadastrarConcursoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonCadastrarConcursoActionPerformed
        // TODO add your handling code here:
        CRUDConcurso crdC= new CRUDConcurso(this);
        crdC.setVisible(true);

    }//GEN-LAST:event_ButtonCadastrarConcursoActionPerformed

    private void ButtonListarConcursoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonListarConcursoActionPerformed
        // TODO add your handling code here:
        this.carregarTabelaConcurso();
    }//GEN-LAST:event_ButtonListarConcursoActionPerformed
    ...
    private void jMenuItem6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem6ActionPerformed
        // TODO add your handling code here:
        CRUDConcurso crudC= new CRUDConcurso(this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListarConcurso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListarConcurso().setVisible(true);
            }
        });
    }
    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton ButtonCadastrarConcurso;
    private javax.swing.JButton ButtonListarConcurso;
    private javax.swing.JTable TabelaListarConcurso;
