 ...
 */
public class RemoverQuestaoDiscursiva extends javax.swing.JFrame {
    ...
    public RemoverQuestaoDiscursiva(ListarQuestao lquestao, QuestaoDiscursiva questaoDiscursiva) {
        initComponents();
    ...
    private RemoverQuestaoDiscursiva() {
    ...
    private void initComponents() {
        ...
        textAreaRespostaQuestao.setEnabled(false);
    ...
    private void ButtonRemoverQuestaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonRemoverQuestaoActionPerformed
        try {
            ...
            if (JOptionPane.showConfirmDialog(rootPane, "Você reamente quer Remover esta questão?", "Remover Questão", JOptionPane.YES_NO_OPTION) == 0) {
                fachada.removerQuestaoDiscursiva(questaoDiscursiva.getId());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemoverQuestaoDiscursiva.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RemoverQuestaoDiscursiva().setVisible(true);
            }
        });
    }
