...
public class ListarEmpresa extends javax.swing.JFrame {
    ...
    public void carregarTabelaEmpresas() {
        try {
            modelo = new DefaultTableModel();
            modelo.setColumnIdentifiers(new Object[]{"Id", "Nome", "CNPJ", "Telefone", "Cep", "UF", "Cidade"});
            ArrayList<Empresa> empresas = new ArrayList<Empresa>();
            empresas = (ArrayList<Empresa>) fachada.consultarTodosEmpresa();
            for (Empresa empresa : empresas) {
                modelo.addRow(new String[]{Long.toString(empresa.getId()), empresa.getNome(), empresa.getCnpj(), empresa.getTelefone(), empresa.getEndereco().getCep(), empresa.getEndereco().getUf(), empresa.getEndereco().getCidade()});
            }
            tableListarEmpresa.setModel(modelo);
    ...
    private void initComponents() {
        ...
        buttonListarEmpresa = new javax.swing.JButton();
        buttonRemoverEmpresa = new javax.swing.JButton();
        jScrollPane2 = new javax.swing.JScrollPane();
        tableListarEmpresa = new javax.swing.JTable();
        buttonAtualizarEmpresa = new javax.swing.JButton();
        ...
        jLabel1.setText("Listar Empresa");

        buttonListarEmpresa.setText("Listar");
        buttonListarEmpresa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buttonListarEmpresaActionPerformed(evt);
            }
        });

        buttonRemoverEmpresa.setText("Remover");
        buttonRemoverEmpresa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buttonRemoverEmpresaActionPerformed(evt);
            }
        });

        tableListarEmpresa.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        tableListarEmpresa.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        jScrollPane2.setViewportView(tableListarEmpresa);

        buttonAtualizarEmpresa.setText("Atualizar");
        buttonAtualizarEmpresa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buttonAtualizarEmpresaActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(buttonAtualizarEmpresa)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(buttonRemoverEmpresa, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(buttonListarEmpresa, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(20, 20, 20))))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(buttonRemoverEmpresa)
                    .addComponent(buttonListarEmpresa)
                    .addComponent(buttonAtualizarEmpresa)
                    .addComponent(jButton1))
                .addGap(31, 31, 31))
        );
    ...
    private void buttonListarEmpresaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonListarEmpresaActionPerformed
        this.carregarTabelaEmpresas();
    }//GEN-LAST:event_buttonListarEmpresaActionPerformed

    private void buttonRemoverEmpresaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonRemoverEmpresaActionPerformed
        if(tableListarEmpresa.getSelectedRow()==-1){
       JOptionPane.showMessageDialog(rootPane, "Selecione uma empresa para remover");
       }else{
        try {
            Empresa empresa = new Empresa();
            int codigo = tableListarEmpresa.getSelectedRow() ;
            empresa = fachada.consultarEmpresaPorId(Long.parseLong(tableListarEmpresa.getValueAt(codigo , 0).toString()));
            RemoverEmpresa rme = new RemoverEmpresa(empresa, this);
            rme.setVisible(true);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(rootPane, ex.getMessage());
        }
        ...
        // TODO add your handling code here:
    }//GEN-LAST:event_buttonRemoverEmpresaActionPerformed

    private void buttonAtualizarEmpresaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAtualizarEmpresaActionPerformed
        if(tableListarEmpresa.getSelectedRow()==-1){
       JOptionPane.showMessageDialog(rootPane, "Selecione uma empresa para alterar");
       }else{
        try {
            Empresa empresa = new Empresa();
            int codigo = tableListarEmpresa.getSelectedRow() ;
            empresa = fachada.consultarEmpresaPorId(Long.parseLong(tableListarEmpresa.getValueAt(codigo , 0).toString()));            
            AlterarEmpresa ale = new AlterarEmpresa(empresa, this);
            ale.setVisible(true);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(rootPane, ex.getMessage());
        }
        ...
        // TODO add your handling code here:
    }//GEN-LAST:event_buttonAtualizarEmpresaActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        CRUDEmpresa ce = new CRUDEmpresa(this);
        ce.setVisible(true);
    ...
    private javax.swing.JButton buttonAtualizarEmpresa;
    private javax.swing.JButton buttonListarEmpresa;
    private javax.swing.JButton buttonRemoverEmpresa;
    ...
    private javax.swing.JTable tableListarEmpresa;
