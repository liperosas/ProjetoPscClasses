 ...
 */
public class RemoverQuestaoMultiplaEscolha extends javax.swing.JFrame {

    /**
     * Creates new form RemoverQuestao
     */
    ListarQuestao lquestao;
    QuestaoMultiplaEscolha questaoMultipla;
    IFachada fachada = Fachada.obterInstancia();

    public RemoverQuestaoMultiplaEscolha(ListarQuestao lquestao, QuestaoMultiplaEscolha questaoMultipla) {
        initComponents();
        this.lquestao = lquestao;
        this.questaoMultipla = questaoMultipla;
        this.carregarAlternativas();
        textAreaTextoQuestao.setText(questaoMultipla.getTexto());
        textElaboradorQuestao.setText(questaoMultipla.getElaborador().getNome());
        textGeneroQuestao.setText(questaoMultipla.getGenero().getGenero());
        textReferenciaQuestao.setText(questaoMultipla.getReferencia());
    }

    private RemoverQuestaoMultiplaEscolha() {
    ...
    private void initComponents() {
        ...
        textAreaTextoQuestao.setEnabled(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemoverQuestaoMultiplaEscolha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RemoverQuestaoMultiplaEscolha().setVisible(true);
            }
        });
    }
